...
function Students() {
    const [students,errorMessage,name,Batch,roll,stuClass,flag,updatedIndex,loading,ctaloading,deleteHandler,updateHandler,ctaHandler,ctaUpdateHandler,setName,setBatch,setRoll,setStuClass] = useStudents();
